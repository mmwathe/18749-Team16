...
# List of server IPs
SERVER_IPS = ['172.26.12.147','172.26.18.137']  # Replace with actual server IPs
class Client:
    def __init__(self, server_port, client_id):
        self.server_ips = SERVER_IPS
        self.primary_server = 0
    ...
    def send_message(self, sock, message, receiver, ip):
        ...
        try:
            ...
            self.primary_server = (self.primary_server + 1) % 3
